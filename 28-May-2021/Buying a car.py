...
decrease of 1.5 percent per month. Furthermore this percent of loss increases of 0.5
percent at the end of every two months. Our man finds it difficult to make all these calculations.
...
at the end of each considered month but if, by chance from the start, the value of the
old car is bigger than the value of the new one or equal there is no saving to be made,
...
def nbMonths(startPriceOld, startPriceNew, savingperMonth, percentLossByMonth):
    ...
    while startPriceOld + total_saving < startPriceNew:
        ...
        total_saving += savingperMonth
        
        
    return [months,round(total_saving+startPriceOld-startPriceNew)]
